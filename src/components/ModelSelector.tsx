...
import { Cpu, ArrowRight, Loader2, Check, Sparkles, RotateCcw, Key } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-950 via-pink-950 to-indigo-950">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 right-1/3 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      >
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 shadow-lg shadow-pink-500/25 mb-3">
          ...
          {providerInfo ? (
            <div className="flex items-center justify-center gap-2 mt-2">
              ...
              <p className="text-purple-200/70 text-sm">{providerInfo.name}</p>
            </div>
          ) : null}
        </motion.div>
        ...
        >
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all text-sm"
              dir="ltr"
            />
          </div>
          ...
          {/* Models count */}
          {models.length > 0 && (
            <p className="text-xs text-purple-200/50 mb-2 text-center">
              {filteredModels.length} من {models.length} موديل متاح
            </p>
          )}
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-pink-500/25 disabled:shadow-none"
            >
              {isLoading ? (
